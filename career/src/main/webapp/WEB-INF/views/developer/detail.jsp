...
<body>
	...
	<form:form name="developer" modelAttribute="developer" action="${pageContext.request.contextPath}/developer/modify.do" method="post">
		<div class="div_input">
		...
		<div class="div_input">
			...
			<form:input type="text" path="telno" class="select1" />	
