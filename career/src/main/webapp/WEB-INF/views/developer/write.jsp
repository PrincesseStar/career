...
<body>
	...
	<form:form name="developer" modelAttribute="developer" action="${pageContext.request.contextPath}/content/save.do" method="post">
		<div class="div_input">
		...
		<div class="div_input">
			...
			<form:input type="text" path="name" class="select2" />
