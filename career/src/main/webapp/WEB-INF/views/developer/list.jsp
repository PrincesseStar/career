...
<script>
	$(document).ready(function(){
		$("#write").click(function(){
			location.href = "${pageContext.request.contextPath}/developer/write.do";
		});
	});
</script>
</head>
...
<div class="div_search">
	<form name="form" action="${pageContext.request.contextPath}/developer/list.do" method="post">
...
<div class="div_select">
	<table class="type11">
		...
		<tr>
			<td><a href="${pageContext.request.contextPath}/developer/detail.do?seq=${row.seq}">${row.seq}</a></td>
